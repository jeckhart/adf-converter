...
You can then execute your native executable with: `./target/adf-converter-1.0.0-SNAPSHOT-runner`
...
- Systemd Notify ([guide](https://quarkiverse.github.io/quarkiverse-docs/quarkus-systemd-notify/dev/)): Notify Linux service manager (systemd) about start-up completion and other service status changes
